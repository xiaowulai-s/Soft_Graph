...
>
> **未完成内容清单**：见计划文档 [第二点五节](docs/08-v3.0.0-开发计划.md) ——
> 分五类：需外部资源（C1 双基线 / E1 签名）、需管理员复测（B1 partial）、
> UI 未接线（注册表清理 / 备份还原 / 浮窗实例管理）、性能顺延（A2/A3/A7/I-11）、
> 验收未达成（USN ≤5s / 样本 500+）。
> 按用户指示：这些补全后**仍以 3.0.0 版本提交**，不另起版本号。
